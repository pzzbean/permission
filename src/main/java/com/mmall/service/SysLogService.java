...
public class SysLogService {
    ...
    public void recover(int id){
        ...
        switch (sysLog.getType()){
            ...
            case LogType.TYPE_USER:
                ...
                afterUser.setOpeator(RequestHolder.getCurrentUser().getUsername());
            ...
            case LogType.TYPE_ROLE_USER:
                ...
                sysRoleUserService.changeRoleUser(sysLog.getTargetId(), JsonMapper.string2Obj(sysLog.getOldValue(), new TypeReference<List<Integer>>() {}));
                break;
            default:;
        }
    }
    ...
    public PageResult<SysLogWithBLOBs> searchPageList(SearchLogParam param, PageQuery page){
        ...
        try {
            ...
            throw new ParamException("传入的日期格式有问题，正确格式为yyyy-MM-dd HH:mm:ss");
        }
        int count = sysLogMapper.countBySearchLogDto(dto);
        if (count > 0){
            List<SysLogWithBLOBs> logList = sysLogMapper.getPageBySearchLogDto(dto, page);
